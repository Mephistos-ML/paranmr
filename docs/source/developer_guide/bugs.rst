...
2. Check the :ref:`faq` page to see whether the issue has already been described or has a known workaround.

If the problem persists and is not addressed in the FAQ, please open a `GitLab Issue <https://gitlab.com/suturina-group/simpnmr/-/issues>`_
...
3. All relevant input file(s), or a minimal working example that reproduces the problem.
