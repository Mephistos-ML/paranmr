...
This page documents selected SimpNMR-X command-line utilities that operate
...
::
   ...
   simpnmr-x calc_pcs_iso susceptibility.csv 298.0 structure.xyz Fe1
...
::
   ...
   simpnmr-x get_sh --spin 2.0 chiT_regression.csv
