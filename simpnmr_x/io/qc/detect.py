# simpnmr_x/io/qc/detect.py
from __future__ import annotations

from typing import Literal

from simpnmr_x.io.qc.backends.gaussian.detect import is_gaussian_log
from simpnmr_x.io.qc.backends.orca.detect import is_orca_output
