...
from simpnmr_x.app.params.plot_cfg import PlotProfile
from simpnmr_x.viz.style import glyphs, legend, palette, patterns, typography
from simpnmr_x.viz.style.patterns import AccessibilityMode
...
class PlotSpec:
    ...
    def skin_axes(self, ax: Axes):
        ...
        `simpnmr_x.viz.style.typography` directly.
