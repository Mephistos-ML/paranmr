...
from simpnmr_x.cfg.benchmarks import AfcBenchmarkConfig as AfcBenchmarkConfig
from simpnmr_x.cfg.benchmarks import AsdBenchmarkConfig as AsdBenchmarkConfig
