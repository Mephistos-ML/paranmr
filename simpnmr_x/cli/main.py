...
"""Define SimpNMR-X command-line entry points.
...
from simpnmr_x import __version__
from simpnmr_x.app.params.options import RuntimeSettings
from simpnmr_x.app.params.settings import apply_runtime_settings
from simpnmr_x.cfg import config as cfg
from simpnmr_x.cli.set_logging import setup_logging
from simpnmr_x.io.qc.errors import QCError
...
def predict_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import PredictRunOptions
    from simpnmr_x.app.pipelines.predict import run_predict
...
def fit_susc_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import FitSuscRunOptions
    from simpnmr_x.app.pipelines.fit.susc import run_fit_susc
...
def fit_corr_time_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import FitCorrTimeRunOptions
    from simpnmr_x.app.pipelines.fit.corr_time_fit import run_fit_corr_time
...
def plot_hfc_iso_ax_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import PlotHFCIsoAxRunOptions
    from simpnmr_x.app.pipelines.plot.hfc_invar_plot import run_plot_hfc_iso_ax
...
def plot_shift_tdep_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import PlotShiftTdepRunOptions
    from simpnmr_x.app.pipelines.plot.shift_t_plot import run_plot_shift_tdep
...
def calc_pcs_iso_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import CalcPcsIsoRunOptions
    from simpnmr_x.app.pipelines.pcs_iso import run_calc_pcs_iso
...
def calc_pdip_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import CalcPdipRunOptions
    from simpnmr_x.app.pipelines.pdip import run_calc_pdip
...
def extract_hfc_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import ExtractHFCRunOptions
    from simpnmr_x.app.pipelines.extract.hfc_extract import run_extract_hfc
...
def plot_hfc_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import PlotHFCRunOptions
    from simpnmr_x.app.pipelines.plot.hfc_plot import run_plot_hfc
...
def extract_dia_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import ExtractDiaRunOptions
    from simpnmr_x.app.pipelines.extract.dia_extract import run_extract_dia
...
def get_sh_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.params.options import GetSHRunOptions
    from simpnmr_x.app.pipelines.get_sh import run_get_sh
...
def benchmark_a_fc_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.pipelines.benchmarks.hyperfine.a_fc import run_benchmark_a_fc
...
def benchmark_a_sd_cli(uargs: argparse.Namespace, runtime: RuntimeSettings) -> int:
    ...
    from simpnmr_x.app.pipelines.benchmarks.hyperfine.a_sd import run_benchmark_a_sd
...
def read_args(arg_list=None):
    ...
    parser.add_argument(
        "--version",
        action="version",
        version=f"simpnmr-x {__version__}",
    )
    ...
    parser.add_argument(
        ...
        metavar="<str>",
        type=str,
        default=os.environ.get("SIMPNMR_X_PLOT_PROFILE", "paper"),
        help=(
            ...
            "You can also set SIMPNMR_X_PLOT_PROFILE=paper|poster.\n"
            "Default: paper"
        ),
    )
    parser.add_argument(
    ...
    plot_hfc_iso.add_argument("input_file", type=str, help=("SimpNMR-X input file"))
