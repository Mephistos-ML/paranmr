...
"""Bootstrap diagonal GMM moment objective transform."""
...
def bootstrap_diagonal_gmm_transform(
    *,
    ...
    """Build a diagonal inverse-standard-deviation bootstrap GMM transform."""
